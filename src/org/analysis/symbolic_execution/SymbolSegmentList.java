...
public class SymbolSegmentList {
	...
	public SymbolSegmentList() {
		this.numVar = 0;
		this.regName = new String[SymbolSegmentList.MAX_NUM_REG];
		this.regVal = new Value[SymbolSegmentList.MAX_NUM_REG];
	}

	public SymbolSegmentList(Value[] regVal, String[] regName, int numVar) {
		super();
		this.regVal = regVal;
