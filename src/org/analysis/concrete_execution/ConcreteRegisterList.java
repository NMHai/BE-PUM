...
public class ConcreteRegisterList {
	...
	public ConcreteRegisterList() {
		this.numVar = 0;
		this.regName = new String[ConcreteRegisterList.MAX_NUM_REG];
		this.regVal = new long[ConcreteRegisterList.MAX_NUM_REG];
	}

	public ConcreteRegisterList(long[] regVal, String[] regName, int numVar) {
		super();
		this.regVal = regVal;
	...
	public ConcreteRegisterList(TestCaseValue var) {
	...
	public void rr(String dest, long e) {
		...
		regVal[d] = OldBitVector.rr(regVal[d], e);
	}
	...
	public void rl(String dest, long e) {
		...
		regVal[d] = OldBitVector.rl(regVal[d], e);
	}
