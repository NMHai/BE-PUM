...
public class ConcreteSegmentList {
	...
	public ConcreteSegmentList() {
		this.numVar = 0;
		this.regName = new String[ConcreteSegmentList.MAX_NUM_REG];
		this.regVal = new long[ConcreteSegmentList.MAX_NUM_REG];
	}

	public ConcreteSegmentList(long[] regVal, String[] regName, int numVar) {
		super();
		this.regVal = regVal;
	...
	public ConcreteSegmentList(TestCaseValue var) {
