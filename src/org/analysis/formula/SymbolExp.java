...
public class SymbolExp implements Value {
	...
	public SymbolExp(String varName) {
		super();
	...
	public boolean equal(Value e) {
		// TODO Auto-generated method stub
		if (e instanceof SymbolExp)
			return varName.equals(((SymbolExp) e).getVarName());
		return false;
	}
	...
	public Value evaluate() {
		...
		if (valueMap.containsKey(varName))
			return new LongValueOld(valueMap.get(varName));
		return this;
	}
