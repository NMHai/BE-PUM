...
public class GRPDecoder extends InstructionDecoder {
	...
	// Volume 2
	// APPENDIX A - Table A-4. Opcode Extensions for One and Two-byte Opcodes by
	// Group Number.
	private static final InstructionDecoder grpTable[][] = {
			...
			{ new ArithmeticDecoder("addS", ADDR_E, v_mode, ADDR_I, b_mode, Operation.ADD), /*
																							 * note
																							 * :
																							 * sIb
																							 * here
			...
			{ new ArithmeticDecoder("rolb", ADDR_E, b_mode, ADDR_I, b_mode, Operation.RL),
					...
					new ArithmeticDecoder("shrb", ADDR_E, b_mode, ADDR_I, b_mode, Operation.SRL), null,
			...
			{ new ArithmeticDecoder("rolS", ADDR_E, v_mode, ADDR_I, b_mode, Operation.RL),
					...
					new ArithmeticDecoder("shrS", ADDR_E, v_mode, ADDR_I, b_mode, Operation.SRL), null,
			...
			{ new ArithmeticDecoder("rolb", ADDR_E, b_mode, Operation.RL),
					...
					new ArithmeticDecoder("shrb", ADDR_E, b_mode, Operation.SRL), null,
			...
			{ new ArithmeticDecoder("rolS", ADDR_E, v_mode, Operation.RL),
					...
					new ArithmeticDecoder("shrS", ADDR_E, v_mode, Operation.SRL), null,
			...
			{ new ArithmeticDecoder("rolb", ADDR_E, b_mode, ADDR_REG, CL, Operation.RL),
					...
					new ArithmeticDecoder("shrb", ADDR_E, b_mode, ADDR_REG, CL, Operation.SRL), null,
			...
			{ new ArithmeticDecoder("rolS", ADDR_E, v_mode, ADDR_REG, CL, Operation.RL),
					...
					new ArithmeticDecoder("shrS", ADDR_E, v_mode, ADDR_REG, CL, Operation.SRL), null,
					new ArithmeticDecoder("sarS", ADDR_E, v_mode, ADDR_REG, CL, Operation.SRA) },
			{ new InstructionDecoder("testb", ADDR_E, b_mode, ADDR_I, b_mode), null, /*
																					 * new
																					 * InstructionDecoder
																					 * (
																					 * "(bad)"
			...
			{ new InstructionDecoder("testS", ADDR_E, v_mode, ADDR_I, v_mode), null,
			...
			{ new ArithmeticDecoder("incb", ADDR_E, b_mode, Operation.ADD),
					new ArithmeticDecoder("decb", ADDR_E, b_mode, Operation.SUB), null, null, null, null, null, null },
			{ new ArithmeticDecoder("incS", ADDR_E, v_mode, Operation.ADD),
					new ArithmeticDecoder("decS", ADDR_E, v_mode, Operation.SUB),
					new CallDecoder("call", ADDR_E, v_mode), new CallDecoder("lcall", ADDR_E, p_mode),
					new JmpDecoder("jmp", ADDR_E, v_mode), new JmpDecoder("ljmp", ADDR_E, p_mode),
					new InstructionDecoder("pushS", ADDR_E, v_mode), null },
			{ new InstructionDecoder("sldt", ADDR_E, w_mode), new InstructionDecoder("str", ADDR_E, w_mode),
					new InstructionDecoder("lldt", ADDR_E, w_mode), new InstructionDecoder("ltr", ADDR_E, w_mode),
					new InstructionDecoder("verr", ADDR_E, w_mode), new InstructionDecoder("verw", ADDR_E, w_mode),
					null, null },
			{ new InstructionDecoder("sgdt", ADDR_E, w_mode), new InstructionDecoder("sidt", ADDR_E, w_mode),
					new InstructionDecoder("lgdt", ADDR_E, w_mode), new InstructionDecoder("lidt", ADDR_E, w_mode),
					new InstructionDecoder("smsw", ADDR_E, w_mode), null,
					new InstructionDecoder("lmsw", ADDR_E, w_mode), new InstructionDecoder("invlpg", ADDR_E, w_mode) },
			{ null, null, null, null, new InstructionDecoder("btS", ADDR_E, v_mode, ADDR_I, b_mode),
			...
			/* 16 */
			{ null, new SSEInstructionDecoder("cmpxch8b", ADDR_W, q_mode), null, null, null, null, null, null },
			/* 17 */
			{ null, null, new SSEArithmeticDecoder("psrlw", ADDR_P, q_mode, ADDR_I, b_mode, Operation.SRL), null,
					new SSEArithmeticDecoder("psraw", ADDR_P, q_mode, ADDR_I, b_mode, Operation.SRA), null,
					new SSEArithmeticDecoder("psllw", ADDR_P, q_mode, ADDR_I, b_mode, Operation.SLL), null },
			/* 18 */
			{ null, null, new SSEArithmeticDecoder("psrld", ADDR_P, q_mode, ADDR_I, b_mode, Operation.SRL), null,
					new SSEArithmeticDecoder("psrad", ADDR_P, q_mode, ADDR_I, b_mode, Operation.SRA), null,
					new SSEArithmeticDecoder("pslld", ADDR_P, q_mode, ADDR_I, b_mode, Operation.SLL), null },
			/* 19 */
			{ null, null, new SSEArithmeticDecoder("psrlq", ADDR_P, q_mode, ADDR_I, b_mode, Operation.SRL), null, null,
					null, new SSEArithmeticDecoder("psllq", ADDR_P, q_mode, ADDR_I, b_mode, Operation.SLL), null },
			/* 20 - Grp15 */
			{
					// FIXME: JK: I think these are wrong - byteindex is not
					// advanced by constructor
					...
					new SSEInstructionDecoder("stmxcsr", ADDR_E, d_mode), null, null, null,
			...
			{ new SSEInstructionDecoder("prefetchnta", ADDR_E, b_mode),
					...
					new SSEInstructionDecoder("prefetcht2", ADDR_E, b_mode), null, null, null, null },
			/* 22 - Grp12:66 */
			{ null, null, new SSEArithmeticDecoder("psrlw", ADDR_P, dq_mode, ADDR_I, b_mode, Operation.SRL), null,
					new SSEArithmeticDecoder("psraw", ADDR_P, dq_mode, ADDR_I, b_mode, Operation.SRA), null,
					new SSEArithmeticDecoder("psllw", ADDR_P, dq_mode, ADDR_I, b_mode, Operation.SLL), null },
			/* 23 - Grp13:66 */
			{ null, null, new SSEArithmeticDecoder("psrld", ADDR_W, dq_mode, ADDR_I, b_mode, Operation.SRL), null,
					new SSEArithmeticDecoder("psrad", ADDR_W, dq_mode, ADDR_I, b_mode, Operation.SRA), null,
					new SSEArithmeticDecoder("pslld", ADDR_W, dq_mode, ADDR_I, b_mode, Operation.SLL), null },
			/* 24 - - Grp14:66 */
			{ null, null, new SSEArithmeticDecoder("psrlq", ADDR_W, dq_mode, ADDR_I, b_mode, Operation.SRL),
					new SSEArithmeticDecoder("psrldq", ADDR_W, dq_mode, ADDR_I, b_mode, Operation.SRL), null, null,
