...
public class Context {
	...
	/**
	 * Substitutes a variable or memory location with another expression in this
	 * context.
	 * 
	 * @param w
	 *            the variable or memory location to substitute
	 * @param expr
	 *            the substitute
	 */
	...
	/**
	 * Returns the substitute for a specific variable or memory location in this
	 * context. If there is no substitute, returns the parameter.
	 * 
	 * @param w
	 *            the variable or memory location to be queried
	...
	/**
	 * Returns the value assigned to a variable or memory location in this
	 * context.
	 * 
	 * @param w
	 *            the variable or memory location
