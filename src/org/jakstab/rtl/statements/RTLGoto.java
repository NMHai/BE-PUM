...
/**
 * Guarded goto statements, only appear during disassembly, not in CFAs, and do
 * not need to be handled during analyses. These are translated into assumes by
 * StateTransformerFactories.
 * 
...
public class RTLGoto extends AbstractRTLStatement implements RTLStatement {
	...
	public enum Type {
		CALL, RETURN, JUMP, STRING_LENGTH_CHECK, REPEAT
	}
