...
/**
 * Assumptions are generated during control flow reconstruction and encode
 * conditions for control flow branches.
 * 
...
public class RTLAssume extends AbstractRTLStatement implements RTLStatement {
	...
	public RTLStatement evaluate(Context context) {
		...
		/*
		 * if (assumption.equals(ExpressionFactory.getInstance().TRUE)) return
		 * null;
		 */
		return this;
	}
