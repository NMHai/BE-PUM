...
/**
 * Default statement visitor that calls a default implementation for every type
 * of statement. When the default behavior is not overridden, throws
...
public abstract class DefaultStatementVisitor<T> implements StatementVisitor<T> {
	 ...
	 * 
	 * @param stmt
	 *            the RTLStatement passed to the visit method.
