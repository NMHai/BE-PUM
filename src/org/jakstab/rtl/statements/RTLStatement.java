...
public interface RTLStatement extends Comparable<RTLStatement>, StateTransformer {
	...
	/**
	 * Generic accept method for an statement visitor to support the visitor
	 * pattern. Calls the appropriate visit method in visitor and passes through
	 * its return value of parameterized type T.
	 * 
	 * @param <T>
	 *            the return type of the visit method.
	 * @param visitor
	...
	/**
	 * Returns this statement evaluated in the given context. Evaluation may
	 * change the type of all substatements and expressions, and may reduce or
	 * increase the total number of objects. Only statements are actually
	 * modified, embedded RTLExpressions are copied on change to preserve their
	 * immutable property.
	 * 
	 * @param context
	 *            the evaluation context, used for variable assignments and
	...
	/**
	 * Returns whether this statement has already been instantiated, that is,
	 * whether it is not a template but a regular statement.
	 * 
	 * @return true if the statement has been instantiated, false if it is a
	 *         template.
	 */
	...
	/**
	 * Returns the variables used by this statement. At the current state of the
	 * implementation, this includes only registers and flags, not memory
	 * locations.
	 * 
	...
	/**
	 * Returns the label of this statement consisting of its virtual address and
	 * RTL-index.
	 * 
	 ...
	 * 
	 * @param addr
	 *            the new virtual address of this statement.
	 * @param rtlId
	 *            the new RTL index of this statement.
	 */
	...
	/**
	 * Performs type inference on all expressions used in this statement which
	 * have an unknown bit width.
	 * 
	 * @param arch
	 *            TODO
	 * 
	...
	/**
	 * Returns a shallow copy this statement. All expressions are immutable, so
	 * shared expressions in the copy should not be a problem.
	 * 
