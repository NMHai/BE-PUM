...
/**
 * A sequence of RTL statements, only used during SSL instantiation and in stub
 * generation.
 * 
...
public class StatementSequence implements Iterable<RTLStatement>, Serializable {
	...
	/**
	 * Inserts a statement before the start of this sequence when it is not
	...
	/**
	 * Inserts a sequence of statements before the start of this sequence when
	 * the sequence object is not null, otherwise does nothing.
	 * 
	 * @param statements
	 *            the statement sequence to be added
	 */
	...
	/**
	 * Adds a sequence of statements to the end of this sequence when the
	 ...
	 * once, after parsing a SSL specification. Canonical statements do not
	 * contain assignments of the special %RPT and %SKIP registers.
	 * 
	...
	/**
	 * Move all bitrange expressions from the LHS of assignments to the RHS, and
	 * convert all assignment templates to variable or memory assignments.
	 * 
	 * @return
	 */
