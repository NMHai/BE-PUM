...
/**
 * Variables, which can be registers, temporary variables, or template variables
 * in SSL instructions. ExpressionFactory ensures that only one copy of each
 * variable exists at runtime.
 * 
...
public class RTLVariable extends AbstractRTLExpression implements RTLExpression, Writable, Comparable<RTLVariable> {
	...
	public RTLVariable(int index, String name, int bitWidth) {
		this.name = name;
