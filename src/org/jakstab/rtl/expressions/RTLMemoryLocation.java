...
/**
 * A memory location with a specified data type/bit width and an address defined
 * by another expression. IA-32 addresses can also contain a segment register,
...
public class RTLMemoryLocation extends AbstractRTLExpression implements RTLExpression, Writable {
	...
	/**
	 * Return the logical state this memory location refers to. Usually 0, but
	 * can be higher to allow expressions to refer to different memory states,
	 * e.g. as in mem32'[10] = mem32[10] + 5;
	 * 
	...
	public String toString() {
		...
		// if
		// (getUsedVariables().contains(ExpressionFactory.getInstance().stackPointer))
		// sb.append("stack");
		// else
		sb.append("mem");
		if (bitWidth > 0)
	...
	public boolean equals(Object obj) {
		...
		return other.address.equals(address)
				...
				&& (other.segmentRegister == segmentRegister || (segmentRegister != null && segmentRegister
						.equals(other.segmentRegister)));
	}
	...
	public RTLExpression inferBitWidth(Architecture arch, int expectedBitWidth) throws TypeInferenceException {
		...
		// return this;
		// Inferring address bitwidth currently does not work b/c of
		// multiplication.
