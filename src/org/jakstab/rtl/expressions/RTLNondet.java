...
/**
 * A nondeterministic integer value of a specified bit width. Two nondet
 * expressions are never equal to avoid nondet=nondet simplifications during
 * evaluation.
 * 
...
public class RTLNondet extends AbstractRTLExpression implements RTLExpression {
	...
	public boolean equals(Object obj) {
		// Required for correct evaluation, otherwise "nondet == nondet" might
		// evaluate to true...
		return false;
	}
