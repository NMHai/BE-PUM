...
public interface RTLExpression extends BitVectorType {
	...
	/**
	 * Generic accept method for an expression visitor to support the visitor
	 ...
	 * Evaluation may change the type of all subexpressions and may reduce or
	 * increase the total number of objects.
	 * 
	 * @param context
	...
	/**
	 * Returns the set of variables which is contained in this expression. In
	 * this context, variables are only registers and flags, not memory
	 * locations.
	 * 
	 ...
	 * Returns a new expression with inferred types.
	 * 
	 * @param arch
	 *            TODO
	 * @param expectedBitWidth
	 *            the bit width this expression is expected to have
	 * 
	...
	/**
	 * Returns a string representation of this expression similar to toString(),
	 * but with all numbers in hexadecimal format. Used for memory addresses and
	 * jump targets.
	 * 
