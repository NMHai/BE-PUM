...
public class RTLNumber extends AbstractRTLExpression implements RTLExpression, AbstractDomainElement {
	...
	public RTLNumber(long value, int bitWidth) {
		super();
	...
	public boolean equals(Object obj) {
		...
		/*
		 * if (bitWidth == RTLVariable.UNKNOWN_BITWIDTH || other.bitWidth ==
		 * RTLVariable.UNKNOWN_BITWIDTH) return other.value == value;
		 */
	...
	public String toString() {
		...
		// String bw = "<" + (bitWidth==RTLVariable.UNKNOWN_BITWIDTH ? "?" :
		// bitWidth) + ">";
	...
	@Override
	public Collection<RTLNumber> readStorePowerSet(int bitWidth,
