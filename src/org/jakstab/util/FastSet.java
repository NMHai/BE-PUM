...
/**
 * A fast Set implementation that maintains its members as an ArrayList as long
 * as it is small in size, and changes to a LinkedHashSet once it grows large
 * enough to amortize the cost of hashing functions.
 * 
...
public class FastSet<E> extends AbstractSet<E> implements Set<E>, Serializable, Worklist<E> {
	 ...
	 * 
	 * @param elements
	 *            the elements for the new FastSet
	 */
	 ...
	 * 
	 * @param element
	 *            the element for the new FastSet
	 */
	...
	public final boolean add(final E e) {
		// Explicit contains check necessary since ArrayList does not enforce
		// set property
	...
	/**
	 * Returns a new set which is the intersection of this set and the other set
	 * given. Both original sets are unchanged by this operation.
	 * 
	 * @param other
	 ...
	 * Both original sets are unchanged by this operation.
	 * 
	 * @param other
	 *            the other set to unite with this set.
	...
	/**
	 * Picks and removes an element from the set (actually the first one
