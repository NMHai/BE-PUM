...
/**
 * This is an input stream that buffers an entire binary file in advance. All
 * multi-byte integers are read little-endian.
 * 
...
public abstract class BinaryInputBuffer {
	 ...
	 * byte array given. If sucessful, returns true and advances the file
	 * pointer by bytes.length. If unsuccessful, will either throw an exception
	 * (if premature EOF) or will returns false. The file position after an
	 * unsuccessful match is undefined, but will be somewhere between start and
	 * (start+bytes.length).
	 */
	 ...
	 * 
	 * @param amount
	 *            the amount to skip, may be negative.
	 ...
	 * 
	 * @param a
	 *            the value to align to, must be positive
	 ...
	 * 
	 * @param bytes
	 *            the array to read into. this will attempt to read bytes.length
	 *            bytes from the file
	 */
	...
	/**
	 * Reads an unsigned byte from the file, returned in the lower 8 bits of an
	 * int. Advances the file pointer by 1.
	 */
	public abstract int readBYTE() throws java.io.IOException;

	/**
	 * Reads a single signed byte from the file without changing the file
	 * pointer.
	 * 
	 * @param fp
	...
	/**
	 * Reads an unsigned 2-byte integer from the file, returned in the lower 2
	 * bytes of an int Advances the file pointer by 2.
	 */
	...
	/**
	 * Reads an unsigned 4-byte integer from the file and returns it the lower 4
	 * bytes of a long. Advances the file pointer by 4.
	 */
	...
	/**
	 * Reads an 8-byte (signed) quantity and returns it in a long. Advances the
	 * file pointer by 8.
	 */
	...
	/**
	 * Reads an int64 (signed) from the file and returns it in a long. Advances
	 * the file pointer by 8.
	 */
	...
	/**
	 * Reads an int32 (signed) from the file and returns it in an int. Advances
	 * the file pointer by 4.
	 */
	...
	/**
	 * Reads an int16 (signed) from the file and returns it in an int. Advances
	 * the file pointer by 2.
	 */
	...
	/**
	 * Reads an int8 (signed) from the file and returns it in an int. Advances
	 * the file pointer by 1.
	 */
	...
	/**
	 * Reads an r4 from the file and returns it in a float. Advances the file
	 * pointer by 4.
	 */
	...
	/**
	 * Reads an r8 from the file and returns it in a double. Advances the file
	 * pointer by 8.
	 */
	...
	public abstract void setBYTE(int fp, long value) throws java.io.IOException;
