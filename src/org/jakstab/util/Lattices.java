...
public class Lattices {
	...
	/**
	 * For a lattice element e and a collection C of lattice elements, returns
	 * an element r which is the join of e with a distinct member of C, and for
	 * which no join of e with a member of C is strictly less wrt. the lattice.
	 * Formally, returns r s.t. e \neq r \and (\exists x \in C. r = e \join x)
	 * \and (\not\exists x \in C. (e \join x) \lt r
	 * 
	 * @param <L>
	 *            The lattice type
	 * @param e
	 *            The lattice element to find a supremum for
	 * @param elementSet
	 *            The set of lattice elements to choose from
