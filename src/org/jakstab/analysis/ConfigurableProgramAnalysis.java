...
public interface ConfigurableProgramAnalysis {
	...
	/**
	 * The abstract transfer function of the program analysis. For a given
	 * state, calculates the abstract successor states based on the supplied
	 * state transformer. Returns null if the state does not have any
	 * successors.
	 * 
	 * @param state
	 *            an abstract state
	 ...
	 * be called by a composite analysis after computing post to improve
	 * precision beyond a purely cartesian combination of analyses.
	 * 
	 * @param s
	 *            an abstract state
	 * @param otherStates
	 *            a sequence of states from different analyses
	 * @param cfaEdge
	 *            the control flow edge that produced s and the other states
	 * @param precision
	 *            the current precision
	 ...
	 * 
	 * @param s1
	 *            the state used for weakening
	 * @param s2
	 *            the state to be weakened.
	 * @param precision
	 *            the current precision
	 ...
	 * @param reached
	 *            a collection of states which will be checked for covering s
	 * @param precision
	 *            the current precision
	 ...
	 * 
	 * @param label
	 *            the initial location for this analysis
	 ...
	 * 
	 * @param location
	 *            the location for which this precision is created
	 * @param transformer
