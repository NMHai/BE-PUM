...
public interface AbstractStore extends LatticeElement {
	...
	/**
	 * Read an abstract value of the given bitwidth at the provided symbolic
	 * address.
	 * 
	 * @param address
	 *            a symbolic address to read from
	 * @param bitWidth
	 *            the bitwidth of the memory access
	 * @return the abstract value associated with the symbolic address in this
	 *         store
	 */
	public AbstractValue get(AbstractValue address, int bitWidth);

	/**
	 * Write an abstract value with the given bitwidth to the provided symbolic
	 * address.
	 * 
	 * @param address
	 *            a symbolic address to write to
	 * @param value
