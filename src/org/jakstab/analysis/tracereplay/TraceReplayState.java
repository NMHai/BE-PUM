...
public class TraceReplayState implements UnderApproximateState {
	 ...
	 * 
	 * @return an AbsoluteAddress corresponding to the PC value for the analyzed
	 *         module.
	 */
	...
	/**
	 * Get the value of the program counter at the current state's successor
	 * state.
	 * 
	 * @return an AbsoluteAddress corresponding to the next PC value for the
	 *         analyzed module.
	 */
	...
	public Set<Tuple<RTLNumber>> projectionFromConcretization(RTLExpression... expressions) {
		...
		for (AbsoluteAddress successor : getNextPC()) {
			...
			if (target instanceof RTLNumber) {
				// If target is a number, this is a direct jump, and maybe
				// conditional
