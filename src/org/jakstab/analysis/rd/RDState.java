...
/**
 * A template for an analysis state for reaching definitions. All methods that
 * need to be implemented are marked with TODO.
 * 
 */
...
public class RDState implements AbstractState {
	...
	public boolean lessOrEqual(LatticeElement l) {
		RDState other = (RDState) l;
		// TODO Check if this state is less or equal to another state with
		// respect to
	...
	public boolean equals(Object arg0) {
		// TODO Override equals such that (x.lessOrEqual(y) && y.lessOrEqual(x))
	...
	@Override
	public int hashCode() {
		// TODO Override hashcode to allow storing this state in a map or set
		// (required)
	...
	public String toString() {
		// TODO Print reaching definition information for all variables to a
		// string.
