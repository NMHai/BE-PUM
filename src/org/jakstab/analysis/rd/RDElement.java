...
/**
 * Template for a helper class for the reaching definition for an individual
 * variable. Implementing this class is not required, but is probably helpful.
 */
...
public class RDElement implements LatticeElement {
	...
	public boolean lessOrEqual(LatticeElement l) {
		RDElement other = (RDElement) l;
		// TODO Check if this value is less or equal to another value with
		// respect to
