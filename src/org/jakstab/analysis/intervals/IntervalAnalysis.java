...
public class IntervalAnalysis implements ConfigurableProgramAnalysis {
	...
	/*
	 * @see
	 * org.jakstab.analysis.ConfigurableProgramAnalysis#post(org.jakstab.analysis
	 * .AbstractState, org.jakstab.analysis.StateTransformer,
	...
	public AbstractState strengthen(AbstractState s, Iterable<AbstractState> otherStates, CFAEdge cfaEdge,
		...
		for (AbstractState t : otherStates) {
			// TODO: Does not work correctly if BoundedAddressTracking returns
			// more than
			// one successor state.
