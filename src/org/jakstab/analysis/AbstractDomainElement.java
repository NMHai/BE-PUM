...
/**
 * This interface defines the methods required by the abstract evaluation
 * function of the generic ValuationState.
 * 
...
public interface AbstractDomainElement extends AbstractValue {
	...
	/**
	 * Reads abstract values from a partitioned memory at the address pointed to
	 * by this abstract value. If more than one value is read, they are not
	 * joined but returned as a collection.
	 * 
	 * @param bitWidth
	 *            The bit width of the memory read
	 * @param store
	...
	/**
	 * Reads an abstract value from a partitioned memory at the address pointed
	 * to by this abstract value. If more than one value is read, their join is
	 * returned.
	 * 
	 * @param bitWidth
	 *            The bit width of the memory read
	 ...
	 * 
	 * @param <A>
	 *            The type of abstract value written
	 * @param bitWidth
	 *            the bit width of the memory write
	 * @param store
	 *            The abstract memory to be written to
	 * @param value
