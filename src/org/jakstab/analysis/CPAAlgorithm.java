...
public class CPAAlgorithm implements Algorithm {
	...
	/**
	 * Instantiates a new CPA algorithm with a forward location analysis, a
	 * default forward transformer factory and worklist suitable for an analysis
	 * of a complete and already reconstructed control flow automaton.
	 * 
	 * @param program
	 *            The program object
	 * @param cpas
	...
	/**
	 * Instantiates a new CPA algorithm with a backward location analysis, a
	 * default backward transformer factory and worklist suitable for an
	 * analysis of a complete and already reconstructed control flow automaton.
	 * 
	 * @param program
	 *            The program object
	 * @param cpas
					...
					for (AbstractState succ : successors) {
						...
						for (AbstractState r : statesToAdd) {
							...
							if (reached.add(r)) {
								worklist.add(r);
								if (art != null)
									art.addChild(unadjustedState, r);
							}
						}
						...
						if (!cpa.stop(succ, reached, targetPrecision)
							...
							reached.add(succ);
							if (art != null)
								art.addChild(unadjustedState, succ);
						}
					}
