...
/**
 * A generic interface to SMT solvers, represents a logical context that can be
 * updated with assertions and checked for satisfiability.
 * 
...
public abstract class Solver {
	...
	/**
	 * Adds a formula to the logical context. All assertions are evaluated in
	 * conjunction.
	 * 
	 * @param f
	 *            the formula to add
	...
	/**
	 * Checks if the logical context is satisfiable, i.e., if there exists a
	 * variable assignment such that each assertion evaluates to the bitvector 1
	 * of size 1 (the RTLExpression TRUE).
	 * 
