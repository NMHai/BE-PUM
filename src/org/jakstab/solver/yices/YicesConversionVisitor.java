...
public class YicesConversionVisitor implements ExpressionVisitor<String> {
	...
	public String visit(RTLMemoryLocation e) {
		...
		if (e.getSegmentRegister() == null) {
			...
			case 8:
				...
				/*
				 * case 8: return YicesWrapper.makeOperation(mem, address); case
				 * 16: return
				 * YicesWrapper.makeBVConcat(YicesWrapper.makeOperation(mem,
				 * addOffset(address, 1)), YicesWrapper.makeOperation(mem,
				 * address) ); case 32: return
				 * YicesWrapper.makeBVConcat(YicesWrapper.makeOperation(mem,
				 * addOffset(address, 3)),
				 * YicesWrapper.makeBVConcat(YicesWrapper.makeOperation(mem,
				 * addOffset(address, 2)),
	...
	private String yicesOperator(Operator op) {
		...
		default:
			throw new UnrepresentableElementException(op.toString());
		}
