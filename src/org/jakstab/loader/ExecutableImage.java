 ...
 * logical structure of a binary executable file. Virtual addresses are
 * represented as objects of type {@code AbsoluteAddress} and calculated using
 * the default base address defined by the image. If the image does not define a
 * base address, a value of zero is used.
 * 
 * Implementations usually assume that multiple executable images do not overlap
 * and perform no relocation.
 */
public interface ExecutableImage {
	 ...
	 * 
	 * @param va
	 *            a virtual address that lies within the values of
	 *            {@code getMinAddress()} and {@code getMaxAddress()}.
	 * @return A file pointer, which is an offset into the byte array returned
	 *         by {@code getByteArray()}.
	 */
	public long getFilePointer(AbsoluteAddress va);

	/**
	 * Retrieves the entry point of the executable, i.e., the address to which
	 * the operating system loader first transfers control. This might not be
	 * the {@code main} function, but initializer code by the runtime libraries.
	 * 
	...
	/**
	 * Get an iterator that iterates over all bytes that can possibly be code in
	 * this module.
	 * 
	...
	/**
	 * Checks whether the specified virtual address is inside a code area of
	 * this executable.
	 * 
	 * @param va
	...
	/**
	 * Read a static memory location, i.e., the initial value of a global
	 * variable or a constant.
	 * 
	 * @param m
	 *            The absolute virtual address in IL syntax as an
	 *            {@code RTLMemoryLocation} object.
	 * @return The result of the memory read as a number object of the requested
	 *         bit length.
	 */
	 ...
	 * used for limiting conservative approximation of memory to actually
	 * modifiable parts.
	 * 
	 * @param a
	 *            a virtual address pointing inside the image's address space
	...
	/**
	 * Returns a disassembler object for this module, which can be used for
	 * disassembling individual instructions.
	 * 
	 * @return a disassembler object, or {@code null} if no disassembler is
	 *         available.
	 */
	public Disassembler getDisassembler();

	/**
	 * Returns the set of unresolved symbols referenced from this module. Used
	 * for resolving dependencies between multiple modules.
	 * 
	 * @return a set of unresolved symbols, or an empty set if it does not
	 *         contain any.
	 */
	public Set<UnresolvedSymbol> getUnresolvedSymbols();

	/**
	 * Returns the set of symbols exported by this module. Used for resolving
	 * dependencies between multiple modules.
	 * 
	 * @return a set of exported symbols, or an empty set if it does not contain
	 *         any.
	 */
