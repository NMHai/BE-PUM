...
/**
 * This class holds a data directory entry, which comes after the PE header in a
 * PE/COFF file. A data directory entry has only 2 fields: VirtualAddress and
 * Size. The VirtualAddress is an RVA to the data for this entry, and the Size
 * is the size in bytes of that entry.
 * 
...
public class ImageDataDirectory {
	...
	/*
	 * public void output(){ System.out.print("{\n  VirtualAddress = " + "0x" +
	 * Long.toHexString(VirtualAddress)); System.out.print("\n  Size = " + Size
	 * + "\n}"); }
	 */
