...
class SymbolEntry {
	 ...
	 * 
	 * @return true if the symbol is a global variable or external function,
	 *         false otherwise.
	 */
	...
	/**
	 * Does the symbol refer to a static value, i.e. a string literal or a jump
	 * table?
	 * 
	 * @return true, if the value field refers to the offset of the value
	 *         relative to it's section start, false if it is something else.
	 */
