...
public class ImageExportDirectory {
	...
	public long Base; // Starting ordinal of exports, usually 1
	// RVA(ord) = EAT[ord - Base];
	public long NumberOfFunctions; // The number of entries in the EAT. Some
									// entries
	// may be 0.
	public long NumberOfNames; // The number of entries in the Export Names
								// Table
	// (ENT). This
	// value will always be less than or equal to the NumberOf-Functions field.
	// It will be less when there are symbols exported by ordinal only. It can
	// also
	// be less if there are numeric gaps in the assigned ordinals. This field is
	// also the size of the export ordinal table (below).
	public long AddressOfFunctions; // RVA of EAT.
