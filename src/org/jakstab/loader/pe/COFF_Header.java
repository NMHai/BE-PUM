...
/**
 * This class holds the data from the COFF Header in a PE/COFF file. The COFF
 * header comes right after the PE signature, and right before the PE header.
 * 
...
public class COFF_Header {
	...
	private static final int IMAGE_FILE_MACHINE_UNKNOWN = 0x0; // The contents
																// of this field
																// are assumed
																// to be
																// applicable to
	...
	private static final int IMAGE_FILE_MACHINE_ARM = 0x1c0; // ARM little
																// endian
	private static final int IMAGE_FILE_MACHINE_EBC = 0xebc; // EFI byte code
	private static final int IMAGE_FILE_MACHINE_I386 = 0x14c; // Intel 386 or
																// later
																// processors
																// and
																// compatible
																// processors
	private static final int IMAGE_FILE_MACHINE_IA64 = 0x200; // Intel Itanium
																// processor
																// family
	private static final int IMAGE_FILE_MACHINE_M32R = 0x9041; // Mitsubishi
																// M32R little
																// endian
	private static final int IMAGE_FILE_MACHINE_MIPS16 = 0x266; // MIPS16
	private static final int IMAGE_FILE_MACHINE_MIPSFPU = 0x366; // MIPS with
																	// FPU
	private static final int IMAGE_FILE_MACHINE_MIPSFPU16 = 0x466; // MIPS16
																	// with FPU
	private static final int IMAGE_FILE_MACHINE_POWERPC = 0x1f0; // Power PC
																	// little
																	// endian
	private static final int IMAGE_FILE_MACHINE_POWERPCFP = 0x1f1; // Power PC
																	// with
																	// floating
																	// point
																	// support
	private static final int IMAGE_FILE_MACHINE_R4000 = 0x166; // MIPS little
																// endian
	private static final int IMAGE_FILE_MACHINE_SH3 = 0x1a2; // Hitachi SH3
	private static final int IMAGE_FILE_MACHINE_SH3DSP = 0x1a3; // Hitachi SH3
																// DSP
	...
	private static final int IMAGE_FILE_MACHINE_WCEMIPSV2 = 0x169; // MIPS
																	// little
																	// endian
																	// WCE v2
