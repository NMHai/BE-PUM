...
/**
 * This inteface serves as an address factory. If you need to implement your own
 * addresses, you should extend this.
 * 
...
public interface IAddressFactory {
	 ...
	 * 
	 * 1. Method should be able to create address from hex address string
	 * (string produced with IAddress.toHexAddressString() method). 2. Method
	 * should be case insensetive 3. Method should be able to create address
	 * from decimal address representation 4. Method should throw
	 * NumberFormatException if the given string cannot be decoded. 5. Method
	 * should not attempt to evaluate string as expression (i.e., "0x1000 + 5"
	 * should not result in an IAddress for 0x1005.) Input must be a
	 ...
	 * 
	 * Method should throw NumberFormatException if the given string cannot be
	 * decoded.
	 * 
	 * Method should not attempt to evaluate string as expression (i.e.,
	 * "1000 + 5" should not result in an IAddress for 1005.) Input must be a
	 * straightforward, absolute value.
	 * 
	 * @param addr
	 * @param radix
