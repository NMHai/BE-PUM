...
public class X86PCRelativeAddress extends PCRelativeAddress {
	...
	/**
	 * Returns the displacement as it is encoded in the instruction, that is,
	 * from the start of the next instruction. To get the displacement from the
	 * start of the current instruction, one needs to add the instruction size.
	 * 
