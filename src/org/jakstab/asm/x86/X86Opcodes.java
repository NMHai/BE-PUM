...
public interface X86Opcodes {
	...
	public static final int ps_mode = 8; // SSE: 128bit single precision
											// floating point data
	public static final int pd_mode = 9; // SSE: 128bit double precision
											// floating point data
	public static final int sd_mode = 10; // SSE: 128bit scalar double precision
											// floating point data
	public static final int q_mode = 11; // SSE: quadword
	public static final int ss_mode = 12; // SSE: scalar element of 128bit
											// floating data
	public static final int si_mode = 13; // SSE: doubleword integer register
											// (e.g. eax)
	...
	// SSE
	public static final int ADDR_W = 19; // modR/M: either a 128 bit XMM
											// register or memory
	public static final int ADDR_Q = 20; // modR/M: either a 128 bit MMX
											// register or memory
	public static final int ADDR_V = 21; // reg field of modR/M selects a
											// 128-bit XMM register
	public static final int ADDR_P = 22; // reg field of modR/M selects a 64-bit
											// MMX register
	public static final int ADDR_RMR = 23; // --JK: rm-field selects general
											// purpose register
