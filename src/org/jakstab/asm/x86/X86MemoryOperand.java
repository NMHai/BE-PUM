...
/**
 * Represents a memory operand pointed to by Base Index Scale Displacement on
 * x86. May actually be an absolute address if base and index are null.
 * 
...
public class X86MemoryOperand extends MemoryOperand {
	...
	/**
	 * @return the segment register of this memory operand, if specified. If it
	 *         is not specified, returns null.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.jakstab.asm.Operation#toString(long, org.jakstab.asm.SymbolFinder)
	 */
	@Override
