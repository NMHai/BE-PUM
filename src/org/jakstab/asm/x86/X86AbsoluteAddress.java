...
public class X86AbsoluteAddress extends AbsoluteAddress {
	...
	/**
	 * Creates a new direct address from numeric segment and offset values. This
	 * is only used by CALL FAR and JMP FAR (lcall and ljmp in AT&T).
	 * 
	 * @param segment
	 *            the numeric segment value of the address
	 * @param disp
	 *            the address's offset from the segment start
	 */
