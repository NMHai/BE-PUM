...
public abstract class Address extends Operand implements BitVectorType {
	...
	/**
	 * Returns the effective value of this address, which might depend on the
	 * current value of the PC given as parameter, or -1 if the effective value
	...
	public String toString(long currentPc, SymbolFinder symFinder) {
		...
		if (address < 0)
			...
			// PHONG: change here for CALL E8
			if (symFinder == null)
				return "0x" + Long.toHexString(address);
			return symFinder.getSymbolFor(address);
		}
	}
