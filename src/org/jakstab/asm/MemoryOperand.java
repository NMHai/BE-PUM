...
/**
 * A memory operand pointed to by a Base Index Scale Displacement address. The
 * effective address of the operand is calculated as (base + (index * scale) +
 * displacement). Optionally, the index is auto incremented or decremented.
 */
