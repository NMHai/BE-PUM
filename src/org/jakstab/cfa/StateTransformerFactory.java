...
/**
 * A factory for producing CFA edges from an abstract state and a program
 * representation.
 * 
...
public interface StateTransformerFactory {
	...
	/**
	 * Returns the set of CFA edges to be processed for calculating the abstract
	 * successor of a given abstract state.
	 * 
	 * @param a
	 *            the abstract state for calculating successors. The abstract
	 *            state has to contain location information.
