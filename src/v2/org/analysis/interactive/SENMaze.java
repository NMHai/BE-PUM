 ...
 * @author zunc
 */
public class SENMaze extends AnalysisFactory {
	...
	public ACTION_OP onInstruction(BPPath path, long address, Instruction ins) {
		...
		//.text:004015CF	mov     dword ptr [esp], offset aS ; "%s"
		//.text:004015D6	call    _scanf
		if (strInst.contains("scanf")) {
		...
		} else if (address == 0x0401683) {
			//.text:0040167C	mov     dword ptr [esp], offset aYouWin ; "You win!"
			//.text:00401683	call    _puts
