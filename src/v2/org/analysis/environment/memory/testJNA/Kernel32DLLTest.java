...
public interface Kernel32DLLTest extends StdCallLibrary {
	Kernel32DLLTest INSTANCE = (Kernel32DLLTest) Native.loadLibrary("kernel32", Kernel32DLLTest.class,
			W32APIOptions.DEFAULT_OPTIONS);
	Kernel32DLLTest SYNC_INSTANCE = (Kernel32DLLTest) Native.synchronizedLibrary(INSTANCE);
...
//	BOOL SetCurrentDirectory(Pointer lpPathName);
	...
	int GetCurrentDirectoryA(/* _In_ */int nBufferLength, /* _Out_ */
	...
	int GetWindowsDirectoryA(/* _Out_ */Pointer lpBuffer, /* _In_ */int uSize);
	 ...
	 */
	HRSRC FindResource(/* _In_opt_ */HMODULE hModule, /* _In_ */
			String lpName, /* _In_ */String lpType);
