...
public  class DFS_INFO_9 extends Structure {
    ...
    protected List<String> getFieldOrder() {
        return Arrays.asList(new String[] {
                "EntryPath", "Comment", "State", "Timeout", "Guid", "PropertyFlags", "MetadataSize", "SdLengthReserved", "pSecurityDescriptor", "NumberOfStorages", "Storage" });
    }
}
