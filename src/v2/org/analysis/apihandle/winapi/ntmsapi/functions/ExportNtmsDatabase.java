 ...
 * File name: ExportNtmsDatabase.java
 * Author: Vinh Le
 */
...
public class ExportNtmsDatabase extends NtmsapiAPI {
	public ExportNtmsDatabase () {
		super();
		NUM_OF_PARMS = 1;
	}
	...
	public void execute() {
		...
		int ret = NtmsapiDLL.INSTANCE.ExportNtmsDatabase (hSession);
