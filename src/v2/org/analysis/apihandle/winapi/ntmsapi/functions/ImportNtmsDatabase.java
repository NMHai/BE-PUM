 ...
 * File name: ImportNtmsDatabase.java
 * Author: Vinh Le
 */
...
public class ImportNtmsDatabase extends NtmsapiAPI {
	public ImportNtmsDatabase () {
		super();
		NUM_OF_PARMS = 1;
	}
	...
	public void execute() {
		...
		int ret = NtmsapiDLL.INSTANCE.ImportNtmsDatabase (hSession);
