 ...
 * Description:
 */
package v2.org.analysis.apihandle.winapi.wsock32.functions;

import org.jakstab.asm.DataType;
import org.jakstab.asm.x86.X86MemoryOperand;

import v2.org.analysis.apihandle.winapi.structures.WinSock.WSADATA;
import v2.org.analysis.apihandle.winapi.wsock32.Wsock32API;
import v2.org.analysis.apihandle.winapi.wsock32.Wsock32DLL;
 ...
 *
 */
public class WSAStartup extends Wsock32API {
	...
	public void execute() {
		...
		int ret = Wsock32DLL.INSTANCE.WSAStartup(wVersionRequested, lpWSAData);
