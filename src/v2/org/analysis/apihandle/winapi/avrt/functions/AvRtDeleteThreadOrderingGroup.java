 ...
 * File name: AvRtDeleteThreadOrderingGroup.java
 * Author: Vinh Le
 */
...
public class AvRtDeleteThreadOrderingGroup extends AvrtAPI {
	public AvRtDeleteThreadOrderingGroup () {
		super();
		NUM_OF_PARMS = 1;
	}
	...
	public void execute() {
		...
		int ret = AvrtDLL.INSTANCE.AvRtDeleteThreadOrderingGroup (Context);
