 ...
 * File name: AvRtLeaveThreadOrderingGroup.java
 * Author: Vinh Le
 */
...
public class AvRtLeaveThreadOrderingGroup extends AvrtAPI {
	public AvRtLeaveThreadOrderingGroup () {
		super();
		NUM_OF_PARMS = 1;
	}
	...
	public void execute() {
		...
		int ret = AvrtDLL.INSTANCE.AvRtLeaveThreadOrderingGroup (Context);
