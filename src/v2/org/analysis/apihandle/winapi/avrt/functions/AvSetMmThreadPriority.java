 ...
 * File name: AvSetMmThreadPriority.java
 * Author: Vinh Le
 */
...
public class AvSetMmThreadPriority extends AvrtAPI {
	public AvSetMmThreadPriority () {
		super();
		NUM_OF_PARMS = 2;
	}
	...
	public void execute() {
		...
		int ret = AvrtDLL.INSTANCE.AvSetMmThreadPriority (AvrtHandle, Priority);
