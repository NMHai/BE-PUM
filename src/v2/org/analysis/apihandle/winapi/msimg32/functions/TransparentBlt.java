...
public class TransparentBlt extends Msimg32API {
	...
	public void execute() {
		...
		int wSrc = (int) t8;
		int hSrc = (int) t9;
		UINT crTransparent = new UINT (t10);

		// Step 3: call API function
		int ret = Msimg32DLL.INSTANCE.TransparentBlt (hdcDest, xoriginDest, yoriginDest, wDest, hDest, hdcSrc, xoriginSrc, yoriginSrc, wSrc, hSrc, crTransparent);
