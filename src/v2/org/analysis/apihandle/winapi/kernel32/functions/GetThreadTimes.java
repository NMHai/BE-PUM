...
public class GetThreadTimes extends Kernel32API {
	public GetThreadTimes () {
		super();
		NUM_OF_PARMS = 5;
	}
	...
	public void execute() {
		...
		int ret = Kernel32DLL.INSTANCE.GetThreadTimes (hThread, lpCreationTime, lpExitTime, lpKernelTime, lpUserTime);
