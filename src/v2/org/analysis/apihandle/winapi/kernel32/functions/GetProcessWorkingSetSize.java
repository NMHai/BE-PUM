 ...
 * File name: GetProcessWorkingSetSize.java
 * Author: Vinh Le
 */
...
public class GetProcessWorkingSetSize extends Kernel32API {
	...
	public void execute() {
		...
		int ret = Kernel32DLL.INSTANCE.GetProcessWorkingSetSize (hProcess, lpMinimumWorkingSetSize, lpMaximumWorkingSetSize);
