 ...
 * File name: GetSystemWindowsDirectory.java
 * Author: Vinh Le
 */
...
public class GetSystemWindowsDirectory extends Kernel32API {
	public GetSystemWindowsDirectory () {
		super();
		NUM_OF_PARMS = 2;
	}
	...
	public void execute() {
		...
		int ret = Kernel32DLL.INSTANCE.GetSystemWindowsDirectory (lpBuffer, uSize);
