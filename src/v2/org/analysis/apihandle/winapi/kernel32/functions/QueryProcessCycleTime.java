 ...
 * File name: QueryProcessCycleTime.java
 * Author: Vinh Le
 */
...
public class QueryProcessCycleTime extends Kernel32API {
	...
	public void execute() {
		...
		int ret = Kernel32DLL.INSTANCE.QueryProcessCycleTime (ProcessHandle, CycleTime);
