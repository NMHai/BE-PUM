 ...
 * File name: GetProfileString.java
 * Author: Vinh Le
 */
...
public class GetProfileString extends Kernel32API {
	...
	public void execute() {
		...
		int ret = Kernel32DLL.INSTANCE.GetProfileString (lpAppName, lpKeyName, lpDefault, lpReturnedString, nSize);
