 ...
 * File name: GetConsoleTitle.java
 * Author: Vinh Le
 */
...
public class GetConsoleTitle extends Kernel32API {
	public GetConsoleTitle () {
		super();
		NUM_OF_PARMS = 2;
	}
	...
	public void execute() {
		...
		int ret = Kernel32DLL.INSTANCE.GetConsoleTitle (lpConsoleTitle, nSize);
