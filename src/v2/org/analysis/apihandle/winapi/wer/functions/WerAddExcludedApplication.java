 ...
 * File name: WerAddExcludedApplication.java
 * Author: Vinh Le
 */
...
public class WerAddExcludedApplication extends WerAPI {
	public WerAddExcludedApplication () {
		super();
		NUM_OF_PARMS = 2;
	}
	...
	public void execute() {
		...
		int ret = WerDLL.INSTANCE.WerAddExcludedApplication (pwzExeName, bAllUsers);
