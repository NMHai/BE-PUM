 ...
 * File name: WerReportCloseHandle.java
 * Author: Vinh Le
 */
...
public class WerReportCloseHandle extends WerAPI {
	public WerReportCloseHandle () {
		super();
		NUM_OF_PARMS = 1;
	}
	...
	public void execute() {
		...
		int ret = WerDLL.INSTANCE.WerReportCloseHandle (hReportHandle);
