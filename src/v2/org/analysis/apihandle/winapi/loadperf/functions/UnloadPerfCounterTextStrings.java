 ...
 * File name: UnloadPerfCounterTextStrings.java
 * Author: Vinh Le
 */
...
public class UnloadPerfCounterTextStrings extends LoadperfAPI {
	public UnloadPerfCounterTextStrings () {
		super();
		NUM_OF_PARMS = 2;
	}
	...
	public void execute() {
		...
		int ret = LoadperfDLL.INSTANCE.UnloadPerfCounterTextStrings (commandLine, bQuietModeArg);
