...
public class RegSaveKeyEx extends Advapi32API {
	public RegSaveKeyEx () {
		super();
		NUM_OF_PARMS = 4;
	}
	...
	public void execute() {
		...
		int ret = Advapi32DLL.INSTANCE.RegSaveKeyEx (hKey, lpFile, lpSecurityAttributes, Flags);
