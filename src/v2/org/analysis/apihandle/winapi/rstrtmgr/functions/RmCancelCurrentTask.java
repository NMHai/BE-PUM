 ...
 * File name: RmCancelCurrentTask.java
 * Author: Vinh Le
 */
...
public class RmCancelCurrentTask extends RstrtmgrAPI {
	public RmCancelCurrentTask () {
		super();
		NUM_OF_PARMS = 1;
	}
	...
	public void execute() {
		...
		int ret = RstrtmgrDLL.INSTANCE.RmCancelCurrentTask (dwSessionHandle);
