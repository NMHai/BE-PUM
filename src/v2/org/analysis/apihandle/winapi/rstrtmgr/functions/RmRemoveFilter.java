...
public class RmRemoveFilter extends RstrtmgrAPI {
	public RmRemoveFilter () {
		super();
		NUM_OF_PARMS = 4;
	}
	...
	public void execute() {
		...
		int ret = RstrtmgrDLL.INSTANCE.RmRemoveFilter (dwSessionHandle, strFilename, Application, strShortServiceName);
