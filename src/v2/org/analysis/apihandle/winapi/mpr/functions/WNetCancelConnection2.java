 ...
 * File name: WNetCancelConnection2.java
 * Author: Vinh Le
 */
...
public class WNetCancelConnection2 extends MprAPI {
	public WNetCancelConnection2 () {
		super();
		NUM_OF_PARMS = 3;
	}
	...
	public void execute() {
		...
		int ret = MprDLL.INSTANCE.WNetCancelConnection2 (lpName, dwFlags, fForce);
