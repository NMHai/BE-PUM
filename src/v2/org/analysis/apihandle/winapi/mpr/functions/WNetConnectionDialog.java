 ...
 * File name: WNetConnectionDialog.java
 * Author: Vinh Le
 */
...
public class WNetConnectionDialog extends MprAPI {
	public WNetConnectionDialog () {
		super();
		NUM_OF_PARMS = 2;
	}
	...
	public void execute() {
		...
		int ret = MprDLL.INSTANCE.WNetConnectionDialog (hwnd, dwType);
