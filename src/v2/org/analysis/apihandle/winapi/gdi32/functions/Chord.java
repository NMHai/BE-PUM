...
public class Chord extends Gdi32API {
	public Chord () {
		super();
		NUM_OF_PARMS = 9;
	}
	...
	public void execute() {
		...
		int ret = Gdi32DLL.INSTANCE.Chord (hdc, nLeftRect, nTopRect, nRightRect, nBottomRect, nXRadial1, nYRadial1, nXRadial2, nYRadial2);
