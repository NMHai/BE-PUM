 ...
 * File name: GetTextExtentPoint.java
 * Author: Vinh Le
 */
...
public class GetTextExtentPoint extends Gdi32API {
	public GetTextExtentPoint () {
		super();
		NUM_OF_PARMS = 4;
	}
	...
	public void execute() {
		...
		int ret = Gdi32DLL.INSTANCE.GetTextExtentPoint (hdc, lpString, cbString, lpSize);
