 ...
 * File name: GetTextExtentExPoint.java
 * Author: Vinh Le
 */
...
public class GetTextExtentExPoint extends Gdi32API {
	public GetTextExtentExPoint () {
		super();
		NUM_OF_PARMS = 7;
	}
	...
	public void execute() {
		...
		String lpszStr = null;
		if ( t1 != 0L ) lpszStr = memory.getText(this, t1);
		int cchString = (int) t2;
		...
		int ret = Gdi32DLL.INSTANCE.GetTextExtentExPoint (hdc, lpszStr, cchString, nMaxExtent, lpnFit, alpDx, lpSize);
