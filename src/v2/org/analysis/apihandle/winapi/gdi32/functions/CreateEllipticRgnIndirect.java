 ...
 * File name: CreateEllipticRgnIndirect.java
 * Author: Vinh Le
 */
...
public class CreateEllipticRgnIndirect extends Gdi32API {
	public CreateEllipticRgnIndirect () {
		super();
		NUM_OF_PARMS = 1;
	}
	...
	public void execute() {
		...
		int ret = Gdi32DLL.INSTANCE.CreateEllipticRgnIndirect (lprc);
