 ...
 * File name: ScaleViewportExtEx.java
 * Author: Vinh Le
 */
...
public class ScaleViewportExtEx extends Gdi32API {
	...
	public void execute() {
		...
		int ret = Gdi32DLL.INSTANCE.ScaleViewportExtEx (hdc, Xnum, Xdenom, Ynum, Ydenom, lpSize);
