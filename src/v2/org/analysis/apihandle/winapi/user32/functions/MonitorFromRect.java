 ...
 * File name: MonitorFromRect.java
 * Author: Vinh Le
 */
...
public class MonitorFromRect extends User32API {
	public MonitorFromRect () {
		super();
		NUM_OF_PARMS = 2;
	}
	...
	public void execute() {
		...
		int ret = User32DLL.INSTANCE.MonitorFromRect (lprc, dwFlags);
