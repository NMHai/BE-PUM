 ...
 * File name: DrawFrameControl.java
 * Author: Vinh Le
 */
...
public class DrawFrameControl extends User32API {
	public DrawFrameControl () {
		super();
		NUM_OF_PARMS = 4;
	}
	...
	public void execute() {
		...
		UINT uState = new UINT (t3);

		// Step 3: call API function
		int ret = User32DLL.INSTANCE.DrawFrameControl (hdc, lprc, uType, uState);
