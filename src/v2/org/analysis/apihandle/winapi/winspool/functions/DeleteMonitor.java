...
public class DeleteMonitor extends WinspoolAPI {
	...
	public void execute() {
		...
		String pMonitorName = null;
		if ( t2 != 0L ) pMonitorName = memory.getText(this, t2);

		// Step 3: call API function
		int ret = WinspoolDLL.INSTANCE.DeleteMonitor (pName, pEnvironment, pMonitorName);
