 ...
 * File name: EnumPrintProcessors.java
 * Author: Vinh Le
 */
...
public class EnumPrintProcessors extends WinspoolAPI {
	public EnumPrintProcessors () {
		super();
		NUM_OF_PARMS = 7;
	}
	...
	public void execute() {
		...
		int ret = WinspoolDLL.INSTANCE.EnumPrintProcessors (pName, pEnvironment, Level, pPrintProcessorInfo, cbBuf, pcbNeeded, pcReturned);
