 ...
 * File name: DeletePrintProcessor.java
 * Author: Vinh Le
 */
...
public class DeletePrintProcessor extends WinspoolAPI {
	public DeletePrintProcessor () {
		super();
		NUM_OF_PARMS = 3;
	}
	...
	public void execute() {
		...
		if ( t2 != 0L ) pPrintProcessorName = memory.getText(this, t2);

		// Step 3: call API function
		int ret = WinspoolDLL.INSTANCE.DeletePrintProcessor (pName, pEnvironment, pPrintProcessorName);
