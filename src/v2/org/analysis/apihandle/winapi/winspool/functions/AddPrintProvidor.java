 ...
 * File name: AddPrintProvidor.java
 * Author: Vinh Le
 */
...
public class AddPrintProvidor extends WinspoolAPI {
	public AddPrintProvidor () {
		super();
		NUM_OF_PARMS = 3;
	}
	...
	public void execute() {
		...
		byte pProviderInfo = (byte) t2;

		// Step 3: call API function
		int ret = WinspoolDLL.INSTANCE.AddPrintProvidor (pName, Level, pProviderInfo);
