 ...
 * File name: StartPagePrinter.java
 * Author: Vinh Le
 */
...
public class StartPagePrinter extends WinspoolAPI {
	public StartPagePrinter () {
		super();
		NUM_OF_PARMS = 1;
	}
	...
	public void execute() {
		...
		int ret = WinspoolDLL.INSTANCE.StartPagePrinter (hPrinter);
