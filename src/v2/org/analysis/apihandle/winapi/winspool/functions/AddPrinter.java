...
public class AddPrinter extends WinspoolAPI {
	public AddPrinter () {
		super();
		NUM_OF_PARMS = 3;
	}
	...
	public void execute() {
		...
		PointerByReference pName = new PointerByReference (new Pointer(t0));
		DWORD Level = new DWORD (t1);
		byte pPrinter = (byte) t2;

		// Step 3: call API function
		int ret = WinspoolDLL.INSTANCE.AddPrinter (pName, Level, pPrinter);
