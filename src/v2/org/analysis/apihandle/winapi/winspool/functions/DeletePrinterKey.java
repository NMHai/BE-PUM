 ...
 * File name: DeletePrinterKey.java
 * Author: Vinh Le
 */
...
public class DeletePrinterKey extends WinspoolAPI {
	public DeletePrinterKey () {
		super();
		NUM_OF_PARMS = 2;
	}
	...
	public void execute() {
		...
		int ret = WinspoolDLL.INSTANCE.DeletePrinterKey (hPrinter, pKeyName);
