 ...
 * File name: DeletePrinterDataEx.java
 * Author: Vinh Le
 */
...
public class DeletePrinterDataEx extends WinspoolAPI {
	public DeletePrinterDataEx () {
		super();
		NUM_OF_PARMS = 3;
	}
	...
	public void execute() {
		...
		int ret = WinspoolDLL.INSTANCE.DeletePrinterDataEx (hPrinter, pKeyName, pValueName);
