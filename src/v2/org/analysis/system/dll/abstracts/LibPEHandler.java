...
import org.jakstab.loader.pe.ImageImportDescriptor;
 ...
 * Dynamic-Link Library of Windows API
 * 
 * @author NMHai
 * 
 */
public class LibPEHandler extends AbstractCOFFModule {
	...
	private final LibPESymbolHandler symbolFinder;

	/**
	 * Parses a PEModule from a specified file
	 */
	public LibPEHandler(File peFile) throws IOException, BinaryParseException {
		...
		symbolFinder = new LibPESymbolHandler(this);
