...
public class Kernel32Image {
	...
	private String path = "data/lib/win32/kernel32.dll"; //YenNguyen
	...
	public Kernel32Image() {
		createImage();
		exportTable = new HashMap<AbsoluteAddress, String>();
		initExportTable();
	}

	public Kernel32Image(String path) {
		this.path = path;
		createImage();
		exportTable = new HashMap<AbsoluteAddress, String>();
		initExportTable();
	...
	private void createImage() {
		...
		try {
			// Create PE Handler
			peHandler = new Kernel32PEHandler(file);
