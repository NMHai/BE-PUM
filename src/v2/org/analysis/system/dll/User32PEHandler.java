 ...
 * 
 */
public class User32PEHandler extends AbstractCOFFModule {
	...
	private final User32PESymbolHandler symbolFinder;

	/**
	 * Parses a PEModule from a specified file
	 */
	public User32PEHandler(File peFile) throws IOException, BinaryParseException {
		...
		symbolFinder = new User32PESymbolHandler(this);
