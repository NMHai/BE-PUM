 ...
 * 
 */
public class Advapi32PEHandler extends AbstractCOFFModule {
	...
	private final Advapi32PESymbolHandler symbolFinder;

	/**
	 * Parses a PEModule from a specified file
	 */
	public Advapi32PEHandler(File peFile) throws IOException, BinaryParseException {
		...
		symbolFinder = new Advapi32PESymbolHandler(this);
