...
0x004112da:	jmp 0x004152a0
0x004152a0:	pushl %ebp
0x004152a1:	movl %ebp, %esp
0x004152a3:	subl %esp, $0xc0<UINT32>
0x004152a9:	pushl %ebx
0x004152aa:	pushl %esi
0x004152ab:	pushl %edi
0x004152ac:	leal %edi, -192(%ebp)
0x004152b2:	movl %ecx, $0x30<UINT32>
0x004152b7:	movl %eax, $0xcccccccc<UINT32>
0x004152bc:	rep stosl %es:(%edi), %eax
0x004152be:	xorl %eax, %eax
0x004152c0:	popl %edi
0x004152c1:	popl %esi
0x004152c2:	popl %ebx
0x004152c3:	movl %esp, %ebp
0x004152c5:	popl %ebp
0x004152c6:	ret
