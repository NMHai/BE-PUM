...
0x00401180:	jmp 0x00404119
0x00404119:	jmp CreateFileA@kernel32.dll
...
0x004011fe:	jmp 0x00404132
0x00404132:	jmp WriteFile@kernel32.dll
WriteFile@kernel32.dll: API Node	
0x00401041:	pushl %ebx
0x00401042:	call 0x00401174
0x00401174:	jmp 0x00404114
0x00404114:	jmp CloseHandle@kernel32.dll
...
0x004011aa:	jmp 0x0040411e
0x0040411e:	jmp GetCurrentDirectoryA@kernel32.dll
...
0x004011ec:	jmp 0x0040412d
0x0040412d:	jmp LoadLibraryA@kernel32.dll
...
0x004011c8:	jmp 0x00404128
0x00404128:	jmp GetProcAddress@kernel32.dll
...
0x004011c2:	jmp 0x00404123
0x00404123:	jmp GetModuleHandleA@kernel32.dll
