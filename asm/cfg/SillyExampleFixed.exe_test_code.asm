...
0x004012da:	jne 0x004012fb
0x004012fb:	movl -28(%ebp), %edi
0x004012fe:	jmp 0x00401327
...
0x00402f72:	call SetHandleCount@kernel32.dll
...
0x00402cc1:	je 14
0x00402cc3:	addl %eax, %ebp
0x00402cc5:	cmpw (%eax), %bx
0x00402cc8:	jne 0x00402cc3
0x00402cca:	addl %eax, %ebp
0x00402ccc:	cmpw (%eax), %bx
0x00402ccf:	jne 0x00402cc3
...
0x00403ea6:	orb 0x40b0a1(%eax), $0x20<UINT8>
0x00403ead:	movb %cl, 0x194(%ebp,%eax)
0x00403eb4:	jmp 0x00403e99
...
0x004029c1:	jne 0x004029ad
0x004029ad:	cmpb %al, $0x3d<UINT8>
0x004029af:	je 0x004029b2
0x004029b2:	pushl %esi
0x004029b3:	call 0x00403650
0x00403650:	movl %ecx, 0x4(%esp)
0x00403654:	testl %ecx, $0x3<UINT32>
0x0040365a:	je 0x00403680
0x00403680:	movl %eax, (%ecx)
0x00403682:	movl %edx, $0x7efefeff<UINT32>
0x00403687:	addl %edx, %eax
0x00403689:	xorl %eax, $0xffffffff<UINT8>
0x0040368c:	xorl %eax, %edx
0x0040368e:	addl %ecx, $0x4<UINT8>
0x00403691:	testl %eax, $0x81010100<UINT32>
0x00403696:	je 0x00403680
0x00403698:	movl %eax, -4(%ecx)
0x0040369b:	testb %al, %al
0x0040369d:	je 0x004036d1
0x004036d1:	leal %eax, -4(%ecx)
0x004036d4:	movl %ecx, 0x4(%esp)
0x004036d8:	subl %eax, %ecx
0x004036da:	ret

0x004029b8:	popl %ecx
0x004029b9:	leal %esi, 0x1(%esi,%eax)
0x004029b1:	incl %edi
0x0040365c:	movb %al, (%ecx)
0x0040365e:	addl %ecx, $0x1<UINT8>
0x00403661:	testb %al, %al
0x00403663:	je 78
0x00403665:	testl %ecx, $0x3<UINT32>
0x0040366b:	jne 0x0040365c
0x0040366d:	addl %eax, $0x0<UINT32>
0x00403672:	leal %esp, (%esp)
0x00403679:	leal %esp, (%esp)
0x0040369f:	testb %ah, %ah
0x004036a1:	je 36
0x004036a3:	testl %eax, $0xff0000<UINT32>
0x004036a8:	je 0x004036bd
0x004036bd:	leal %eax, -2(%ecx)
0x004036c0:	movl %ecx, 0x4(%esp)
0x004036c4:	subl %eax, %ecx
0x004036c6:	ret
...
0x00402a17:	jne 0x004029eb
0x004029eb:	pushl %esi
0x004029ec:	call 0x00403650
0x004029f1:	movl %ebp, %eax
0x004029f3:	incl %ebp
0x004029f4:	cmpb (%esi), $0x3d<UINT8>
0x004029f7:	popl %ecx
0x004029f8:	je 0x00402a13
0x00402a13:	addl %esi, %ebp
0x004029fa:	pushl %ebp
0x004029fb:	call 0x004034ec
0x00402a00:	cmpl %eax, %ebx
0x00402a02:	popl %ecx
0x00402a03:	movl (%edi), %eax
0x00402a05:	je 55
0x00402a07:	pushl %esi
0x00402a08:	pushl %eax
0x00402a09:	call 0x00404fb0
0x00404fb0:	pushl %edi
0x00404fb1:	movl %edi, 0x8(%esp)
0x00404fb5:	jmp 0x00405025
0x00405025:	movl %ecx, 0xc(%esp)
0x00405029:	testl %ecx, $0x3<UINT32>
0x0040502f:	je 29
0x00405031:	movb %dl, (%ecx)
0x00405033:	addl %ecx, $0x1<UINT8>
0x00405036:	testb %dl, %dl
0x00405038:	je 102
0x0040503a:	movb (%edi), %dl
0x0040503c:	addl %edi, $0x1<UINT8>
0x0040503f:	testl %ecx, $0x3<UINT32>
0x00405045:	jne 0x00405031
0x00405047:	jmp 0x0040504e
0x0040504e:	movl %edx, $0x7efefeff<UINT32>
0x00405053:	movl %eax, (%ecx)
0x00405055:	addl %edx, %eax
0x00405057:	xorl %eax, $0xffffffff<UINT8>
0x0040505a:	xorl %eax, %edx
0x0040505c:	movl %edx, (%ecx)
0x0040505e:	addl %ecx, $0x4<UINT8>
0x00405061:	testl %eax, $0x81010100<UINT32>
0x00405066:	je -31
0x00405068:	testb %dl, %dl
0x0040506a:	je 52
0x0040506c:	testb %dh, %dh
0x0040506e:	je 39
0x00405070:	testl %edx, $0xff0000<UINT32>
0x00405076:	je 0x0040508a
0x0040508a:	movw (%edi), %dx
0x0040508d:	movl %eax, 0x8(%esp)
0x00405091:	movb 0x2(%edi), $0x0<UINT8>
0x00405095:	popl %edi
0x00405096:	ret

0x00402a0e:	popl %ecx
0x00402a0f:	popl %ecx
0x00402a10:	addl %edi, $0x4<UINT8>
...
0x00401ca0:	jnl 0x00401cab
0x00401ca2:	movl -56(%ebp), $0x1<UINT32>
0x00401cab:	andl -48(%ebp), $0xfffffff7<UINT8>
0x00401caf:	movl %eax, $0x200<UINT32>
0x00401cb4:	cmpl -56(%ebp), %eax
0x00401cb7:	jle 0x00401cbc
0x00401cb9:	movl -56(%ebp), %eax
